...
from simulator.datagen.state_machine.pump_bottle_press import PumpBottlePressStateMachine
...
TASK_REGISTRY = {
    ...
    "HCIS-PumpBottlePress-SingleArm-v0": (PumpBottlePressStateMachine, "keyboard"),
}
